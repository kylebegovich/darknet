...
VPATH=./src/:./examples
SLIB=libdarknet.so libopenalpr.so
ALIB=libdarknet.a libopenalpr-static.a
EXEC=darknet
OBJDIR=./obj/
...
DEPS = $(wildcard src/*.h) Makefile include/darknet.h include/alpr_c.h
