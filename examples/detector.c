...
void test_detector(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh, float hier_thresh, char *outfile, int fullscreen)
{
    ...
    while(1){
        ...
        info *result = malloc(sizeof(info*)*1000); /* new struct 'by Chen' to save information of ouput */
        draw_detections_info(im, l.w*l.h*l.n, thresh, boxes, probs, masks, names, alphabet, l.classes, result);
        if(outfile){
